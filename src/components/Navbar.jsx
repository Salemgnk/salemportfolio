        ...
        <div className="px-4 py-2">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-4 text-lg font-mono">
              <button onClick={() => handleNavClick('#hero')} className={`px-3 py-1 hover:bg-white/10 rounded-lg ${textColor}`}>
                About
              </button>
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-2 pb-2 space-y-2 text-lg font-mono">
              <button onClick={() => handleNavClick('#hero')} className={`block w-full text-left px-3 py-2 hover:bg-white/10 rounded-lg ${textColor}`}>
                About
              </button>
